...
const items = [
  ...
  },
  {
    id: "3",
    desc: `“On the Windows talking painted pasture yet its express parties use. Sure last upon he same as knew next. Of believed or diverted no.”`,
    image: "diandra-agatha.jpg",
    author: "Oni Noor",
    role: "Ponorogo, East Java",
  },
];
  ...
  return (
    <section className="mb-28">
      <div className="max-w-7xl mx-auto relative px-4">
        <div className="flex">
          <div className="w-5/12  pl-8 pr-20">
          ...
          <div className="w-1/12 items-center flex z-40">
